    ...
    <el-card>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        ...
        <el-tab-pane label="动态参数" name="many">
          <!-- 添加参数的按钮 -->
          <el-button style="background-color: #dbe9f0" size="mini" :disabled="isBtnDisabled" @click="addDialogVisible=true">添加参数</el-button>
          <!-- 动态参数表格 -->
        ...
        <el-tab-pane label="静态属性" name="only">
          <!-- 添加属性的按钮 -->
          <el-button style="background-color: #dbe9f0" size="mini" :disabled="isBtnDisabled" @click="addDialogVisible=true">添加属性</el-button>
          <!-- 静态属性表格 -->
...
export default {
  ...
  methods: {
    ...
    async saveAttrVals(row) {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error('修改标签项失败！')
      }
