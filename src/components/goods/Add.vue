      ...
      <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position="top">
        <el-tabs :tab-position="'left'" v-model="activeIndex" :before-leave="beforeTableave" @tab-click="tabClicked">
          ...
          <el-tab-pane label="商品参数" name="1">
            ...
            <el-form-item :label="item.attr_name" v-for="item in manyTableData" :key="item.attr_id">
              ...
              <el-checkbox-group v-model="item.attr_vals">
                <el-checkbox border size="mini" v-for="(cb, i) in item.attr_vals" :key="i" :label="cb"></el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          </el-tab-pane>
          ...
          <el-tab-pane label="商品图片" name="3">
            ...
            >
            <el-button size="small" style="background-color: #dbe9f0">点击上传</el-button>
            <div slot="tip">只能上传jpg/png文件，且不超过500kb。 限3张</div>
          </el-upload>
          </el-tab-pane>
          <el-tab-pane label="商品内容" name="4">
            ...
            <!-- 添加商品的按钮 -->
            <el-button size="small" style="background-color: #dbe9f0" class="btnAdd" @click="add">添加商品</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-card>
