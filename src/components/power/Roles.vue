<template>
  <div>
    ...
    <el-card>
      ...
      <el-row>
        <el-col>
          <el-button style="background-color: #dbe9f0" @click="addRoleDialogVisible = true">添加角色</el-button>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    async editRoleDialog (id) {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error('展示角色信息失败！')
      }
    ...
    // 点击为角色分配权限，...展开运算符es6，将数组展开合并成一个数组
    async allotRights() {
      const keys = [
